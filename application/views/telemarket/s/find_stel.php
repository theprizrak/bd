...
<?/*<form action="/stelemarketing/find" method="post" name="find_klient"><div class="tu findklient">Введите фамилию контакта<br><input name="family" type="text" value="<?if(isset($_POST['family']) && $_POST['family']!=''){echo $_POST['family'];}?>"><br><input class="buttons_fil" name="find_fam_ok" type="submit" value="Найти"></div></form>
<form action="/stelemarketing/find" method="post" name="find_klient"><div class="tre findklient">Введите Имя контакта<br><input name="name" type="text" value="<?if(isset($_POST['name']) && $_POST['name']!=''){echo $_POST['name'];}?>"><br><input class="buttons_fil" name="find_name_ok" type="submit" value="Найти"></div></form>
*/?>
</div>
<form action="/stelemarketing/find" method="post" name="find_klient">
