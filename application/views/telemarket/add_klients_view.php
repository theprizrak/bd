...
{
   var e1=$('select[name="perezvon_tm"]').val();
   if(e1=='1')
   { $('.Sel1').fadeIn(300); }
   else
   { $('.Sel1').fadeOut(300); }
...
function vstrrre()
{
   var e2=$('select[name="vstrecha"]').val();
   if(e2=='1')
   { $('.vstr1').fadeIn(300); }
   else
   { $('.vstr1').fadeOut(300); }
...
function otkazvstr()
{
   var e3=$('select[name="otkaz_tm"]').val();
   if(e3==1)
...
<input type="text" name="who_user" class="add" value="tm" style="width: 1px;height: 1px;display: none;">
  ...
  <tr>
    ...
    <option value="0" <?php echo set_select('otkaz_tm', '0'); ?>>Нет</option>
  ...
  <tr class="Sel2" style="display: none; background: #EDF3A8;">
    ...
    <option value="0" <?php echo set_select('vstrecha', '0'); ?>>Нет</option>
    <option value="1" <?php echo set_select('vstrecha', '1', TRUE); ?>>Да</option>
    </select>
    </td>
  </tr>
  ...
  <tr class="vstr1 otkz" style="display: none; background: #A8F3AE;">
    ...
    <option value="0" selected="selected" <?php echo set_select('type_procedur', '0', TRUE); ?>>&nbsp;</option>
 	<option value="СПА Лицо" <?php echo set_select('type_procedur', 'СПА Лицо'); ?>>СПА Лицо</option>
    <option value="СПА Тело" <?php echo set_select('type_procedur', 'СПА Тело'); ?>>СПА Тело</option>
    <option value="СПА Волосы" <?php echo set_select('type_procedur', 'СПА Волосы'); ?>>СПА Волосы</option>
  </select>
    </td>
  </tr>
