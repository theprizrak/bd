...
<td>
    <!-- .slideThree -->
    <div class="slideThree">  
      <input onchange="configuration('color_resep')" type="checkbox" id="slideThree12" name="color_resep" <?if($config['color_resep']=='on'){echo 'checked';}?> />
...
<td>
    <!-- .slideThree -->
    <div class="slideThree">  
      <input onchange="configuration('add_vstr_rtm')" type="checkbox" id="slideThree2" name="add_vstr_rtm" <?if($config['add_vstr_rtm']=='on'){echo 'checked';}?> />
...
<td>
    <!-- .slideThree -->
    <div class="slideThree">  
      <input onchange="configuration('add_prvn_rtm')" type="checkbox" id="slideThree2" name="add_prvn_rtm" <?if($config['add_prvn_rtm']=='on'){echo 'checked';}?> />
      <label for="slideThree2"></label>
    </div>
    <!-- end .slideThree -->
</td>
...
<td>
    <!-- .slideThree -->
    <div class="slideThree">  
      <input onchange="configuration('edit_vstr_tm')" type="checkbox" id="slideThree3" name="edit_vstr_tm" <?if($config['edit_vstr_tm']=='on'){echo 'checked';}?> />
...
<td>
    <!-- .slideThree -->
    <div class="slideThree">  
      <input onchange="configuration('color_serv_tm')" type="checkbox" id="slideThree4" name="color_serv_tm" <?if($config['color_serv_tm']=='on'){echo 'checked';}?> />
...
<td>
    <!-- .slideThree -->
    <div class="slideThree">  
      <input onchange="configuration('color_serv_resep')" type="checkbox" id="slideThree13" name="color_serv_resep" <?if($config['color_serv_resep']=='on'){echo 'checked';}?> />
...
<td>
    <!-- .slideThree -->
    <div class="slideThree">  
      <input onchange="configuration('color_serv_doc')" type="checkbox" id="slideThree15" name="color_serv_doc" <?if($config['color_serv_doc']=='on'){echo 'checked';}?> />
...
<td>
    <!-- .slideThree -->
    <div class="slideThree">  
      <input onchange="configuration('add_vstr_rserv')" type="checkbox" id="slideThree5" name="add_vstr_rserv" <?if($config['add_vstr_rserv']=='on'){echo 'checked';}?> />
...
<td>
    <!-- .slideThree -->
    <div class="slideThree">  
      <input onchange="configuration('add_kl_rserv')" type="checkbox" id="slideThree6" name="add_kl_rserv" <?if($config['add_kl_rserv']=='on'){echo 'checked';}?> />
...
<td>
    <!-- .slideThree -->
    <div class="slideThree">  
      <input onchange="configuration('add_kl_doc')" type="checkbox" id="slideThree14" name="add_kl_doc" <?if($config['add_kl_doc']=='on'){echo 'checked';}?> />
...
<td>
    <!-- .slideThree -->
    <div class="slideThree">  
      <input onchange="configuration('add_doc_rserv')" type="checkbox" id="slideThree7" name="add_doc_rserv" <?if($config['add_doc_rserv']=='on'){echo 'checked';}?> />
...
<td>
    <!-- .slideThree -->
    <div class="slideThree">  
      <input onchange="configuration('view_proc_rserv')" type="checkbox" id="slideThree8" name="view_proc_rserv'" <?if($config['view_proc_rserv']=='on'){echo 'checked';}?> />
...
<td>
    <!-- .slideThree -->
    <div class="slideThree">  
      <input onchange="configuration('add_proc_rserv')" type="checkbox" id="slideThree9" name="add_proc_rserv" <?if($config['add_proc_rserv']=='on'){echo 'checked';}?> />
...
<td>
    <!-- .slideThree -->
    <div class="slideThree">  
      <input onchange="configuration('del_proc_rserv')" type="checkbox" id="slideThree10" name="del_proc_rserv" <?if($config['del_proc_rserv']=='on'){echo 'checked';}?> />
...
<td>
    <!-- .slideThree -->
    <div class="slideThree">  
      <input onchange="configuration('sost_proc_rserv')" type="checkbox" id="slideThree11" name="sost_proc_rserv" <?if($config['sost_proc_rserv']=='on'){echo 'checked';}?> />
...
<thead>
<tr>
<td width="30%">Наименование Отдела</td>
<td width="70%">Описание</td>
</tr>
</thead>
<tbody>
<?
$group_assets=$this->user_model->get_group_assets('otdel');
foreach($group_assets as $assets):
?>
<tr>
<td><?=$assets['name_otdel'];?></td>
<td><?=$assets['desc_otdel'];?></td>
</tr>
<?endforeach;?>
</tbody>
</table>
<div style="text-align: center;"><input type="button" value="Добавить новый отдел" onclick="new_group('new_otdel')" class="buttons" /></div>
