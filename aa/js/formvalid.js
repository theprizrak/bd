$(document).ready(function(){
        jVal = {
            ...
            'family' : function() {
                ...
                jVal.errors = true;
                $('input[name=add_ok]').attr('disabled',true);
                familyInfo.removeClass('correct').addClass('error').html('← Минимум 3 символов').show();
                ele.removeClass('normal').addClass('wrong');
                } else {
            ...
            var patt = /^+7([0-9]{3})\-[0-9]{3}\-[0-9]{2}\-[0-9]{2}$/i;
                if(!patt.test(ele.val())) {
                jVal.errors = true;
                phoneInfo.removeClass('correct').addClass('error').html('← type in date in correct format').show();
                ele.removeClass('normal').addClass('wrong');
                } else {
                $('input[name=add_ok]').attr('disabled',false);
